        ...
        <nav class="nav">
            <div>
                <a href="index.php" class="nav__logo">
                    ...
                    <span class="nav__logo-name">Ashok Caterers </span>
                </a>
                ...
                <div class="nav__list">
                    ...
                    <a href="incomeReport.php?page=contactManage" class="nav__link nav-contactManage">
                    <i class="fa-solid fa-sack-dollar"></i>
                        <span class="nav__name">Income Report</span>
                    </a>
