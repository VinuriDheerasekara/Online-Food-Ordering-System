...
<body>
  ...
  <div class="container my-3 mb-5">
    ...
    <div class="row" width = "100%">
        <image src = "img/Cake4to_3.jpg" width = "300px" height = "auto" style="text-align: left;"/>
        <h1 style="text-align: right;"> Red Diamond </h1><br>
    ...
    <div class="row">
        <image src = "img/Cake4to_3.jpg" width = "300px" height = "auto" />
        <h1 style="text-align: right;"> Red Diamond </h1><br>
        <button>Book Hall</button>
    </div>
    <div class="row">
