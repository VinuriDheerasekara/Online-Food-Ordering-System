...
echo '</div>
          ...
          <li class="nav-item">
            <a class="nav-link" href="hall.php">Reception Hall</a>
          </li>';
$sqlUserType = "SELECT userType from `users` where id = $userId";
$res = mysqli_query($conn, $sqlUserType);
if (mysqli_num_rows($res) > 0) {
  $userType[] = mysqli_fetch_assoc($res);
  if ($userType[0]['userType'] == 1) {
    echo '<li class="nav-item">
    <a class="nav-link" href="admin/incomeReport.php">Sales Summery</a>
  </li>';
  };
}
